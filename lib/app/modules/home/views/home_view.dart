...
class HomeView extends GetView<HomeController> {
                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Container(
                                        ...
                                        padding:EdgeInsets.only(right: 15,top: 15,left: 15,bottom: 0),
                                        ...
                                        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              Text("Get preminum",style: TextStyle(
                                                color: Col.inverseSecondary,fontSize: 28,
                                                fontFamily: 'BeausiteClassic',
                                                fontWeight: FontWeight.w500,
                                                letterSpacing: 0.8,

                                              ),),
                                              Text('Download and listen',style: TextStyle(
                                                fontSize: 16,
                                                fontWeight:FontWeight.w400,color:Col.inverseSecondary,
                                                height: 1.5,
                                                letterSpacing: 0.8

                                              )),Text('your book',style: TextStyle(
                                                fontSize: 16,
                                                fontWeight:FontWeight.w400,color:Col.inverseSecondary,
                                                height: 1.5,
                                                letterSpacing: 0.8
                                                ...
                                                child: ElevatedButton(
                                                  style: ElevatedButton.styleFrom(
                                                    ...
                                                    onPressed: (){
                                                      ...
                                                      controller.clickOnSubscription();
                                                    }, child: Text(
                                                  "Subscribe Now",style: TextStyle(
                                                  color: Col.inverseSecondary,fontSize: 20,fontWeight: FontWeight.w500,
                                                  letterSpacing: 0.5,
                                                ),
                                                )),
                                              )
  ...
  Widget imageViewNotification() => Icon(Icons.notifications_none,weight:22.px );
