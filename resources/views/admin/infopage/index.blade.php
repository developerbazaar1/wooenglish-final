...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa-sharp fa-solid fa-check-to-slot"></i> Add Info Page</h1>
        </div>
    </div>
                ...
                <div class="tile-body">
                    <div class=" cst-add-new-form row">
                        ...
                        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                            <form class="Add-page-form w-auto " method="POST" action="{{route('info-page-store')}}" enctype="multipart/form-data">
                              @csrf
                              ...
                              <div class="form-group">
                                ...
                                <input name="document" type="file" class="dropify  @error('document') is-invalid @enderror"
                                    data-height="100" data-allowed-file-extensions="jpeg jpg png" />
                                @error('document')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                         ...
                         @if(count($pages) > 0)
                           ...
                           <tr>
                             @php  $pageid = Crypt::encrypt($page->id);  @endphp
                              ...
                              <td class=""> <a class="btn btn-primary" href="{{ route('info-page-edit', $pageid )}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a></td>
                              <td class="">
                                 <a href="#" class="delet-btn demoSwal" id="demoSwal" data-id="{{$page->id}}" data-uri="delete-info-page">
