...
class C {
  ...
  static const textSubscriptionDis = "Download and listen your book Audio.  ";
  ...
  // Popup text
  static const readbookPopupFirst =   'Access a page with options to select different chapters.';
