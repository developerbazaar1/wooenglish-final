...
class FirebaseMethod {
  ...
  Future<FirebaseUser?> facebookSigningRequest() async {
    ...
    if (await CM.internetConnectionCheckerMethod()) {
      ...
      if (result.status == LoginStatus.success) {
        ...
        print("faceboooookkkkk:::::${userDataStore}");
        firebaseUser = FirebaseUser(
  ...
  Future<void> shareDynamicLink({
    ...
    String link =
        "http://wooenglish.page.link?${C.routes}=$routes&${C.bookId}=$bookId&${C.authorId}=$authorId&${C.categoryId}=$categoryId&${C.chapterId}=$chapterId";
    String uriPrefix = 'http://wooenglish.page.link';
    String packageName = "app.woo.english.woo_english";
    String url =
    ...
    final DynamicLinkParameters parameters = DynamicLinkParameters(
        ...
        iosParameters: const IOSParameters(
          bundleId: "app.woo.english.woo_english",
        ));
