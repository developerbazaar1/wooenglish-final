        ...
        child: Scaffold(
          ...
          body: Stack(
            children: [
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    if (controller
                                                      ...
                                                      commonViewTwo(
                                                          value:
                                                              "${C.textGenre}${controller.getBookDetailDataModel.value?.genreName ?? ""}",
                                                          width: 188.px),
                                                  ],
                                                ),
                                              ),
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    if (controller
                                                      ...
                                                      commonViewTwo(
                                                          value:
                                                              "${C.textLevelBokDetails}${controller.getBookDetailDataModel.value?.levelName ?? ""}",
                                                          width: 188.px),
                                                    if (controller
                                                            .getBookDetailDataModel
                                                            .value
              ...
              if (popupvalue == null || popupvalue == 2)
                Obx(() {
                  print("this is pop up value $popupvalue");
                  print("this is userkey value $isUserLogin");
                  return controller.popupValue.value == 2
                      ? FutureBuilder<bool>(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        showPopup.widgetRow(
                                            ...
                                            'Save the book to your favorite.'),
                                        SizedBox(
                                          height: 8,
                                        ),
                                        showPopup.widgetRow(
                                            ...
                                            'Share the book with friends and others.'),
                                        SizedBox(
                                          height: 8,
                                        ),
                                        showPopup.widgetRow(
              ...
              // if(popupvalue == 2)
              Obx(() {
                return controller.popupValue.value == 3
                    ? FutureBuilder<bool>(
                        future: showPopup.shouldShowPopup(),
                        builder: (context, snapshot) {
                          //if (isUserLogin.isEmpty) {
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Flexible(
                                          child: Text(
                                              'Choose to read, listen, or watch a video of the book.',
                                              style: TextStyle(
                                                color: Colors.black,
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          title: Text(
            C.textExclusiveTitle,
            textAlign: TextAlign.center,
          ),
          content: Text(
            C.textExclusivePopup,
