class GetDashBoardBooksModel {
  ...
  GetDashBoardBooksModel.fromJson(Map<String, dynamic> json) {
    ...
    englishAccentName = json['english_accent_name'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['length_name'] = this.lengthName;
    data['language_name'] = this.languageName;
    data['level_name'] = this.levelName;
    data['english_accent_name'] = this.englishAccentName;
    if (page != null) {
