...
class FavoritesBooksView extends GetView<FavoritesBooksController> {
  const FavoritesBooksView({Key? key}) : super(key: key);
                    ...
                    if (AppController.isConnect.value) {
                      if (controller.responseCode.value == 200 ||
                        ...
                        if (controller.booksList.isNotEmpty) {
                          ...
                          return CW.commonNoDataFoundImage(                              onRefresh: () => controller.onRefresh(),
);
                        }
                      } else {
