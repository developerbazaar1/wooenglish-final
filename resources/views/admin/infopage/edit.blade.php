    ...
    <main class="app-content">
        <div class="app-title">
            ...
            <ul class="app-breadcrumb breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="{{ route('info-pages') }}">Pages</a></li>
            </ul>
        </div>
            ...
            <div class="tile">
                <div class="tile-body">
                    <div id="app_content" class="app-container">
                        ...
                        <form class="w-100" id="addpage-form" method="POST" action="{{route('info-page-update')}}" enctype="multipart/form-data">
                          @csrf
                            ...
                            <div class=" cst-add-new-form row m-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="document"  data-default-file="{{ URL::asset('/public/'.$page->image) }}" type="file" class="dropify  @error('document') is-invalid @enderror"
